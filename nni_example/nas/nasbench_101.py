...
from nni.retiarii.evaluator.pytorch_lightning.callbacks import LearningRateMonitor
...
def _multi_trial_test(epochs, batch_size, port, benchmark):
    ...
    train_dataset = serialize(CIFAR10, '/home/shenghao/dataset', train=True, download=True, transform=transforms.Compose(transf + normalize))
    test_dataset = serialize(CIFAR10, '/home/shenghao/dataset', train=False, transform=transforms.Compose(normalize))
